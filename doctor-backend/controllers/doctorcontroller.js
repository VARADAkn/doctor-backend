...
exports.createDoctor = async (req, res) => {
  ...
  await logActivity(req, 'CREATE_DOCTOR', 'DOCTOR', doctor.id, {
    name: doctor.name,
...
exports.updateDoctor = async (req, res) => {
  ...
  await logActivity(req, 'UPDATE_DOCTOR', 'DOCTOR', id, {
    updates: Object.keys(req.body).filter(k => k !== 'id')
  });
...
exports.deleteDoctor = async (req, res) => {
  ...
  await logActivity(req, 'DELETE_DOCTOR', 'DOCTOR', id);
