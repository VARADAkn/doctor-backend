from tensorflow.keras.applications import EfficientNetB0, EfficientNetB3, EfficientNetB4, EfficientNetB5, EfficientNetB6, EfficientNetB7
'''
...
def model_parameter(selected_model):
    model_list = {
        "model_tiny": {
            ...
            "savedModelByName": "Model_Tiny_EffB0.h5",
            "saveFinalModelBy": "Model_Tiny",
            'log_by': "Model_Tiny_EffB0.csv",
            'save_plot_name': 'Model_Tiny_EffB0',
            'prediction_csv_name': 'Model_Tiny_EffB0_prediction',
